/**
 * Return Scan Challan Screen
 * Allows vendors to scan or upload return delivery challan document
 */
...
export default function ReturnScanChallanScreen() {
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.background.primary }]}>
      ...
      {/* Header */}
      <ScreenHeader title="Scan Return Challan" />
      ...
      <View style={[styles.content, { backgroundColor: theme.colors.background.secondary }]}>
        ...
        {/* Title */}
        <Text style={[styles.title, { color: theme.colors.text.primary }]}>Scan return challan</Text>
        ...
        <View style={styles.actionButtons}>
          {/* Open Camera Button */}
          <TouchableOpacity style={[styles.cameraButton, { borderColor: theme.colors.primary, backgroundColor: theme.colors.background.primary }]} onPress={handleOpenCamera}>
          ...
          <TouchableOpacity style={[styles.galleryButton, { backgroundColor: theme.colors.primary }]} onPress={handleUploadGallery}>
            ...
            <Text style={[styles.galleryButtonText, { color: '#FFFFFF' }]}>Upload with gallery</Text>
          </TouchableOpacity>
        </View>
      </View>
